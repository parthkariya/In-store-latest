...
const AddRetailerLandingPageTileCard = ({
  openMallModal,
  setTab,
  gatweek,
  setweek,
  ...
  return (
    <div className="leaderboard-card-main-wrapp">
      ...
      <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
          ...
          {files && files.length > 0 ? (
            ...
            <div style={{ width: "100%" }} {...getRootlogoProps()}>
              <div className="leaderboard-card-part-sec2 ">
                ...
                />
                <h4>.JPG .PNG (689 x 474 pixels) </h4>
        ...
        <div
          className="leaderboard-card-part-third leaderboard-card-part-third-chng"
...
export default AddRetailerLandingPageTileCard;
