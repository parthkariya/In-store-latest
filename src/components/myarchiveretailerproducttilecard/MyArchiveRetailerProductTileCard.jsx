...
import "./MyArchiveRetailerProductTileCard.css";
...
const MyArchiveRetailerProductTileCard = ({ item, setTab, getweek, getregion_array, getProductTiles, getExtendId, setExtendId }) => {

  const eateryvalue = JSON.parse(localStorage.getItem("iseatery"));


  const { DeleteProductTileApi, category_data, UpdateProductTilesApi, category_eatery_data, getStoreCartApi, UpdateLeaderBoardExtedApi } =
    useStoreContext();
  ...
  // console.log("qr code",qrDiscount);
  ...
  const UpdatePromotionBanner = async () => {
    ...
    // }else if ((filesqr.length <=0 || item.qr_image_path == null) && (qrDiscount !== "")) {
...
export default MyArchiveRetailerProductTileCard;