...
const RetailerLandingPageSquareTileCardExtend = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
  ...
  // with video validation backup start
  // useDropzone({
  //   maxFiles: 8,
  //   onDrop: (acceptedFiles) => {
  //     ("accept file are", acceptedFiles);
  //     SetCondation(true);
  ...
  // with video validation backup end
...
export default RetailerLandingPageSquareTileCardExtend;
