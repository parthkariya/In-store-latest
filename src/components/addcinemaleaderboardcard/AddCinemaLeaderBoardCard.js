...
import { ACCEPT_HEADER, get_region_mall_leaderboard_count } from "../../utils/Constant";
...
const AddCinemaLeaderBoardCard = ({
  openMallModal,
  setTab,
  gatweek,
  setweek,
  ...
  const DateWisreMall = async () => {
    ...
    console.log("function called",selectedDates);
  ...
  return (
    <div className="leaderboard-card-main-wrapp">
      ...
      <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
        ...
        <div className="leaderboard-card-part-third leaderboard-card-part-third-chng" style={{justifyContent:"flex-end"}}>
          {/* <Link className="leaderboard-delete-icon-btn">
                        cancel{" "}
                        <img src={images.delete_icon} className="leaderboard-delete-icon" />
                    </Link> */}
...
export default AddCinemaLeaderBoardCard;