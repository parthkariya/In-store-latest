...
const AddPromotionBannerCard = ({ openMallModal, setTab, gateweek, seteweek, peopleInfo,
  mallidarray,
  regionidarray,
  selectedMalls, }) => {
  const { CreatePromotionBoardApi, category_data, multiple_week_data, getRetailerApi,cinema_category_data } = useStoreContext();
...
export default AddPromotionBannerCard