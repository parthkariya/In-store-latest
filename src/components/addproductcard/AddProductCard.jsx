  ...
  return (
    <div className="leaderboard-card-main-wrapp ">
      ...
      <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
        ...
        <div className="leaderboard-card-first-resp-main-wrapp leaderboard-card-part-first-half">
        ...
        <div className="brand_banner_img_main">
          <div className="leaderboard-card-part-sec" style={{ width: "100%" }}>
          ...
          <div className="leaderboard-card-part-sec" style={{ width: "100%" }}>
            ...
            {files2 && files2.length > 0 ? (
              ...
              <div style={{ width: "100%" }} {...getRootlogoProps2()}>
                <div className="leaderboard-card-part-sec2">
                  <AiOutlineCloudUpload
                    style={{
                      width: "60px",
          ...
          <div className="leaderboard-card-part-sec" style={{ width: "100%" }}>
            ...
            {files3 && files3.length > 0 ? (
              ...
              <div style={{ width: "100%" }} {...getRootlogoProps3()}>
                <div className="leaderboard-card-part-sec2">
                  <AiOutlineCloudUpload
                    style={{
                      width: "60px",
