...
const MyArchiveCinemaLandingPageLeaderboardCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
    ...
    if (data) {
      if (data.success === 1) {
        ...
        Notification(
          "success",
          "Success!",
          "Landing Page Leaderboard Successfully Deleted!"
        );
...
export default MyArchiveCinemaLandingPageLeaderboardCard;