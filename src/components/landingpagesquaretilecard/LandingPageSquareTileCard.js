...
const LandingPageSquareTileCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
  ...
  const { UpdateLandingpageSquareTileApi, deleteLandingpagSquareTileApi,getStoreCartApi, } =
    useStoreContext();
      ...
      <div className="leaderboard-card-main-wrapp">
        ...
        <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
          ...
          <div className="leaderboard-card-first-resp-main-wrapp">
            ...
            <button className="leaderboard-delete-icon-btn" onClick={()=>{ DeleteLeaderboard();}}>
              cancel{" "}
              <img
...
export default LandingPageSquareTileCard;
