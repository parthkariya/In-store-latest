...
import "./MyArchiveRetailerProductBannerCard.css";
...
const MyArchiveRetailerProductBannerCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
  ...
  const [gettitle, SetTitile] = useState(item.description ? item.description : "");
...
export default MyArchiveRetailerProductBannerCard;
