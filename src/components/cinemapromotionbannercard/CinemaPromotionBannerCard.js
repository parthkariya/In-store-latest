...
const CinemaPromotionBannerCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
      ...
      <div className="leaderboard-card-main-wrapp">
        ...
        <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
          ...
          <div className="leaderboard-card-sec-resp-main-wrapp" style={{ gap: "0.5rem" }}>
            ...
            <div className="leaderboard-btn-box">
              <button className="btn btn-orange" style={{ width: "165px" }} onClick={() => UpdatePromotionBanner()}>Update</button>
            </div>
          </div>
...
export default CinemaPromotionBannerCard;