...
const AddCinemaLandingpageLeaderboardCard = ({
  openMallModal,
  setTab,
  gatweek,
  setweek,
  ...
  const { CreateLeaderBoardApi, category_data, multiple_week_data,cinema_category_data,CreateLandingPageLeaderboard } =
    useStoreContext();
  ...
  return (
    <div className="leaderboard-card-main-wrapp">
      ...
      <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
        ...
        <div className="leaderboard-card-part-sec leaderboard-card-part-sec">
...
export default AddCinemaLandingpageLeaderboardCard;
