...
const CustomerBrandDetailsComponent = ({ getedetalis,setTab,getsingalmalldata,setIsRetailer,isRetailer,getIdTrue ,setcheckID }) => {
        ...
        <div>
            <div className='cus-brand-details-flex'>
                ...
                {getIdTrue == 1 ? <>
                    ...
                    <div className='cus-brand-details-inner-flex-part'>
                        <p className="cus-brand-details-main-txt">Trading Hours:</p> <span className=""> {getedetalis.mon_fri_from_time}am - {getedetalis.mon_fri_to_time}pm</span>
                    </div>
                </> : <>
                <div className='cus-brand-details-inner-flex-part'>
                        <p className="cus-brand-details-main-txt">Shop no:</p> <span className=""> {getedetalis?.parrentstore?.store_no}</span>
                    </div>
                    <div className='cus-brand-details-inner-flex-part'>
                        <p className="cus-brand-details-main-txt">Level: </p> <span className="">{getedetalis?.parrentstore?.store_level}</span>
                    </div>
                    <div className='cus-brand-details-inner-flex-part'>
                        <p className="cus-brand-details-main-txt">Trading Hours:</p> <span className=""> {getedetalis?.parrentstore?.mon_fri_from_time}am - {getedetalis.mon_fri_to_time}pm</span>
                    </div>
                </>}
