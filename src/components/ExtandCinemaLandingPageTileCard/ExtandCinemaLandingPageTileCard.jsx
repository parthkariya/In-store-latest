...
import "./ExtandCinemaLandingPageTileCard.css";
...
const ExtandCinemaLandingPageTileCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
...
export default ExtandCinemaLandingPageTileCard;
