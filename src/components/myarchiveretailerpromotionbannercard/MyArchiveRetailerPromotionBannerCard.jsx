...
import "./MyArchiveRetailerPromotionBannerCard.css";
...
const MyArchiveRetailerPromotionBannerCard = ({
  item,
  mindx,
  getLeaderboard,
  setTab,
  ...
  // console.log("category_eatery_data",category_eatery_data);
  ...
  // console.log("test",getregion_array);
    ...
    <>
      <div className="leaderboard-card-main-wrapp">
        ...
        <div className="leaderboard-card-flex-wrapp leaderboard-card-flex-wrapp-half">
          ...
          <div className="leaderboard-card-part-sec leaderboard-card-part-sec-prom" 
          // {...getRootlogoProps()}
          >
            {/* <input
              {...getInputlogoProps()}
...
export default MyArchiveRetailerPromotionBannerCard;