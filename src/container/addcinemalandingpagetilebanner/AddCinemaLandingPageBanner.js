...
import { AddCinemaLandingPageTileCard, AddLeaderBoardCard, AddPromotionBannerCard, CinemaHero } from "../../components";
...
const AddCinemaLandingPageBanner = ({ get_mall_auth_data, setTab }) => {
  ...
  return (
    ...
    <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
      <div className="leaderboard-sub-wrapp" style={{ margin: "0px" }}>
        ...
        <div className="edit-brand-back-iconbox" onClick={() => setTab(40)}>
        ...
        <div className="mall_name_wrapp mall_name_wrapp-spacebetween mall_name_wrapp_direction_reverse" style={{paddingLeft:"0rem"}}>
          <div className="leaderboard-inner-namebox">
            ...
            <span className="leaderboard-span" style={{ fontWeight: "600" }}>Add Landing Page 1/2 Page Tile</span>
          </div>
        ...
        <p className="leaderboard-sub-heading">
          Purchase marketing space through our Landing Page 1/2 Page Tile Banner below
        </p>
      </div>
...
export default AddCinemaLandingPageBanner;
