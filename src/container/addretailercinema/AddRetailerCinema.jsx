...
const AddRetailerCinema = ({ setTab, gettab, get_mall_auth_data, getsingleStoreData }) => {
    ...
    const AddStoreNallData = async () => {
        ...
        if (mallsOption2 == "" || undefined) {
            ...
            Notification("error", "Error", "Please Enter Cinema");
            return;
        }
    ...
    return (
        <>
            ...
            <></>
                        ...
                        <div className="mm_form_single_input">
                            <label htmlFor="" style={{ minWidth: "157px" }}>Cinema Address<span className="star_require">*</span></label>
                            <input
                                type="text"
                                value={brandadd}
                        ...
                        {/* single text-input */}
                        <div className="mm_form_single_input">
                            <label htmlFor="" className="mm_form_single_input_cinema_Acc_setting">Cinema Email<span className="star_require">*</span></label>
                            <input
                                type="text"
                                value={getbrandemail}
                    ...
                    <div className="brand-add-img-flex">
                        ...
                        <div className="mm_img_upload_wrapp" style={{ width: "100%" }}>
                            ...
                            <div className="myprofile_inner_sec2">
                                ...
                                >
                                    ...
                                    Cinema logo <br /> (200 x 200 pixels) <br /> (max 40kb)
                        ...
                        <div className="mm_img_upload_wrapp" style={{ width: "100%" }}>
                            ...
                            <div className="myprofile_inner_sec2">
                                ...
                                >
                                    Upload black and white <br />
                                    Cinema banner <br /> (1050 x 284 pixels) <br /> (max 200kb)
                                    <span className="star_require">*</span>
                                </h5>
...
export default AddRetailerCinema