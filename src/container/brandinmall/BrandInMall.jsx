...
import { BrandInMallCard, BrandItmCard, RetailerNavigationBar } from "../../components";
...
const BrandInMall = ({ setTab, get_mall_auth_data,getTab }) => {
  const perPage = 3;
      ...
      {loading === true ? (
        ...
        <div className="mm_main_wrapp">
          ...
          <RetailerNavigationBar
              ...
              setTabType={getTab == 8 ? "My Brand in Mall" : ""}
            />
