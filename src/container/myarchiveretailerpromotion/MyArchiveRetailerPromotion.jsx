...
import { PromotionBannerCard, RetailerNavigationBar } from "../../components";
...
import EmptyPromotionBannerCard from "../../components/promotionbannercard/EmptyPromotionBannerCard";
import MyArchiveRetailerPromotionBannerCard from "../../components/myarchiveretailerpromotionbannercard/MyArchiveRetailerPromotionBannerCard";
...
const MyArchiveRetailerPromotion = ({ get_mall_auth_data, setTab, gettab,getExtendId, setExtendId }) => {
  const perPage = 3;
        ...
        <div className="mm_main_wrapp">
          <div className="leaderboard-sub-wrapp" style={{ gap: "1rem" }}>
            <RetailerNavigationBar
              ...
              setTabType={gettab == 34 ? "Promotion Banner" : ""}
            />
            ...
            {/* {getliast && getliast.length > 0 ? (
              getliast.map((mall, mindx) => {
                return ( */}
                  <MyArchiveRetailerPromotionBannerCard
            ...
            {totalPages !== page && (
              ...
              >
                {loading ? "Loading..." : " Load More Promotional Banner"}
                <BsChevronDown />
              </button>
            )}
...
export default MyArchiveRetailerPromotion;
