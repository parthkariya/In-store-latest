...
import { ACCEPT_HEADER, dowmtemp, dowmtempretailer, uploadfile, uploadfileretailer } from "../../utils/Constant";
import { AiOutlineCloudUpload } from "react-icons/ai";
import Notification from "../../utils/Notification";

const RetailerTypeSheet = ({ getsingleStoreData, get_mall_auth_data, getstore_is }) => {
    ...
    const DownTemp = async () => {
        ...
        axios
            .post(dowmtempretailer, formdata, {
                headers: {
    ...
    const Uploadfile = async () => {
        if (files[0] === undefined) {
            ...
            await formdata.append("retailer_id", getstore_is);

            axios
                .post(uploadfileretailer, formdata, {
                    headers: {
                        Accept: ACCEPT_HEADER,
                        Authorization: "Bearer " + token,
                    },
...
export default RetailerTypeSheet;