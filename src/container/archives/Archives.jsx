...
const Archives = ({ setTab,getsingleStoreData,get_mall_auth_data  }) => {
  ...
  return (
    <>
      {loading === true ? (
        ...
        <>
          <div className="MallCart_main" style={{ gap: "2rem" }}>
          <div>
              <h1 className="h3" style={{ fontWeight: "600" }}>
              {mainName}: My Analytics Archives
              </h1>
            </div>
            <div>
