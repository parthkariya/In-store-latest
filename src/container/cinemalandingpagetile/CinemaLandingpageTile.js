...
import { CinemaHero, CinemaLandingPageTileCard, CinemaLeaderBoardCrad, CinemaNavigationBar, LeaderBoardCard, RetailerNavigationBar } from "../../components";
...
import EmptyCinemaLandingPageTileCard from "../../components/cinemalandingpagetilecard/EmptyCinemaLandingPageTileCard";
...
const CinemaLandingpageTile = ({ get_mall_auth_data, setTab, gettab,getMallDisclaimerData }) => {
  const { week_data,getCinema } = useStoreContext();
    ...
    <div>
      {loading === true ? (
        ...
        <div className="mm_main_wrapp">
          ...
          <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 40 ? "Landing Page 1/2 Page Tile " : ""} />
            ...
            >
              <div className="leaderboard-inner-namebox">
                ...
                <span className="leaderboard-span" style={{ fontWeight: "600" }}>Landing Page 1/2 Page Tile</span>
              </div>
            ...
            {/* {getliast && getliast.length > 0
              ...
              {getliast && getliast.length > 0 ? (
                ...
                <EmptyCinemaLandingPageTileCard
                  openMallModal={openMallModal}
                  item={""}
                  mindx={""}
                  getLeaderboard={getLandingpageTile}
...
export default CinemaLandingpageTile;