...
import {
  ...
  RetailerLandingPageTileExtendCard,
...
const MyArchiveRetailerLandingpageTile = ({
  get_mall_auth_data,
  setTab,
  gettab,
  getExtendId,
          ...
          <div className="mm_main_wrapp">
            ...
            >
              <RetailerNavigationBar
                ...
                setTabType={gettab === 32 ? "Landing page 1/2 Page Tile" : ""}
              />
              ...
              {/* );
                ...
                <EmptyRetailLandingPageTileCard
                  openMallModal={openMallModal}
                  item={""}
                  mindx={""}
                  getLeaderboard={getLandingpageTile}
...
export default MyArchiveRetailerLandingpageTile;