...
import { AddCinemaLandingPageTileCard, AddCinemaLandingpageLeaderboardCard, AddLeaderBoardCard, AddPromotionBannerCard, CinemaHero } from "../../components";
...
const AddCinemaLandingpageLeaderboard = ({ get_mall_auth_data, setTab }) => {
    ...
    <>
      ...
      <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
        <div className="leaderboard-sub-wrapp" style={{ margin: "0px" }}>
          ...
          <div className="edit-brand-back-iconbox" onClick={() => setTab(42)}>
          ...
          <div className="mall_name_wrapp mall_name_wrapp-spacebetween mall_name_wrapp_direction_reverse" style={{ paddingLeft: "0rem" }}>
            <div className="leaderboard-inner-namebox">
              ...
              <span className="leaderboard-span" style={{ fontWeight: "600" }}>Add Landing Page Leaderboard Banner</span>
            </div>
          ...
          <p className="leaderboard-sub-heading">
            Purchase marketing space through our Landing Page Leaderboard Banner below
          </p>
        </div>
...
export default AddCinemaLandingpageLeaderboard;
