...
import { AddCinemaPromotionalBannerCard, AddLeaderBoardCard, AddPromotionBannerCard, CinemaHero } from '../../components';
...
const AddCinemaPromotionalBanner = ({ get_mall_auth_data, setTab }) => {
    ...
    return (
        <>
            ...
            <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
                <div className="leaderboard-sub-wrapp" style={{ marginLeft: "0rem", marginRight: "0rem" }}>
                    {/* LeaderBoard name start */}
                    <div className='edit-brand-back-iconbox' onClick={() => setTab(37)}><IoChevronBack className='edit-brand-back-icon' /> <p className='edit-brand-back-txt'>Back</p></div>
                    <div className="mall_name_wrapp mall_name_wrapp-spacebetween" style={{ paddingLeft: "0rem" }}>
                        <div className="leaderboard-inner-namebox">
                            ...
                            <span className="leaderboard-span" style={{ fontWeight: "600" }}>Add Promotion Banners</span>
                        </div>
...
export default AddCinemaPromotionalBanner