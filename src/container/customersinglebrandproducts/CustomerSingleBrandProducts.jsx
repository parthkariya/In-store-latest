...
const CustomerSingleBrandProducts = ({
  getsingalmalldata,
  setTab,
  setBDetalis,
  brandid,
  ...
  useEffect(() => {
    ...
    // console.log("getbdetalis2",getbdetalis2.id);
  ...
  const SingleBrandProductApi = async (id) => {
    ...
    await formdata.append("store_id", getcheckid == 1 ? getbdetalis.id : getbdetalis2.id);
  ...
  const getmovielist = async (id) => {
    ...
    formdata.append("store_id", getcheckid == 1 ? getbdetalis.id : getbdetalis2.id);
      ...
      {loading === true ? (
        ...
        <div className="mall_nearme_brand_main_wrapp">
          ...
          <CustomerHero
            getsingalmalldata={getsingalmalldata}
            sidebaropen={sidebaropen}
            getbdetalis={getcheckid == 1 ? getbdetalis : getbdetalis2}
          />

          {/* <CustomerHeroSecond getsingalmalldata={getbdetalis} /> */}

          <div className="mm_main_wrapp mm_main_wrapp_22">
            <div className='edit-brand-back-iconbox' onClick={() => { getcheckid == 1 ? setTab(26) : setTab(31) }}><IoChevronBack className='edit-brand-back-icon' /> <p className='edit-brand-back-txt'>Back</p></div>
            ...
            {isVisible ? <>            <div className='edit-brand-back-iconbox' style={{ marginTop: "2rem" }} onClick={() => { getcheckid == 1 ? setTab(26) : setTab(31) }}><IoChevronBack className='edit-brand-back-icon' /> <p className='edit-brand-back-txt'>Back</p></div>
            </> : <></>}
