...
import "./MyArchiveRetailerLeaderboard.css";
import images from "../../constants/images";
import { LeaderBoardCard, MyArchiveRetailerExtendLeaderboardCard, RetailerNavigationBar } from "../../components";
...
const MyArchiveRetailerLeaderboard = ({ get_mall_auth_data, setTab, gettab, getExtendId, setExtendId}) => {
  ...
  // console.log("getExtendId",getExtendId);
        ...
        <div className="mm_main_wrapp">
          <div className="leaderboard-sub-wrapp" style={{ gap: "1rem" }}>
            <RetailerNavigationBar
              title="My Archive"
              setTabType={gettab == 33 ? "In Mall Leaderboard Banners" : ""}
            />
            ...
            {/* {getliast && getliast.length > 0 ? (
              getliast.map((mall, mindx) => {
                return ( */}
                  <MyArchiveRetailerExtendLeaderboardCard
...
export default MyArchiveRetailerLeaderboard;