...
import "./CinemaTiles.css"
import { Link } from 'react-router-dom'
import images from '../../constants/images'
import { CinemaHero, CinemaNavigationBar, CinemaTilesCard, ProductTilesCard, RetailerNavigationBar } from '../../components'
// import "./ProductTiles.css"
import { ACCEPT_HEADER, filter_producttilesbanner, get_producttilesbanner, get_region_mall, get_store_region_authwise, store_mall_from_region } from '../../utils/Constant'
...
const CinemaTiles = ({ get_mall_auth_data, setTab, gettab, getMallDisclaimerData }) => {
        ...
        <div>
            {loading === true ? (
                ...
                <>
                    ...
                    <div className="mm_main_wrapp">
                        <div className="leaderboard-sub-wrapp leaderboard-sub-wrapp-cinema">
                            <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 3 ? "Cinema Product Tiles" : ""} />
                            {/* LeaderBoard name start */}
                            <div className="mall_name_wrapp mall_name_wrapp-spacebetween" style={{ marginTop: "0px", paddingLeft: "0rem" }}>
                                <div className="leaderboard-inner-namebox">
                                    ...
                                    <span className="leaderboard-span" style={{ fontWeight: "600" }}>Product Tiles</span>
                                </div>
              ...
              /> */}
                            ...
                            {getliast.length >= 0 ? <button onClick={() => setTab(39)} className='leaderboard-btn'>Add new <img src={images.add_new} className="leaderboard-btn-icon" /></button> : null}
