...
import { ACCEPT_HEADER, get_landingpage_squaretile_without_auth, get_mall, get_mall_master } from "../../utils/Constant";
          ...
          <div className="CinemaHomeProductile_main" >
            ...
            {getHomeSquareTileData && getHomeSquareTileData.map((item ,index) => {
              ...
              return (
                ...
                onMouseEnter={()=>{
                  setIndex(index) 
                }} onClick={()=>{setIsOpen3(true);SetsignButn(3);SetboldButn(3)}}
                >
                  <>
                    {type === 'mp4' ? <>
