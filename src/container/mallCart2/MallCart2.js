            ...
            <div className="MallCart2_main">
              <div className="">
                <h3 className="h3" style={{ fontWeight: "600" }}>
                  ...
                  {get_mall_auth_data.name}: Track My Analytics
                </h3>
              </div>
              <div className="">
                {/* <h5 className="h5" style={{ fontWeight: "600" }}>
                  {getMallDisclaimerData?.cart_description1}
                </h5> */}
                <p style={{ fontWeight: "300" }} dangerouslySetInnerHTML={{ __html: getMallDisclaimerData?.cart_description1 }} />
