...
import { AddCinemaLeaderBoardCard, AddLeaderBoardCard, AddPromotionBannerCard, CinemaHero } from "../../components";
...
const CinemaAddLeaderboardBanner = ({ get_mall_auth_data, setTab }) => {
    ...
    <>
      ...
      <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
        <div className="leaderboard-sub-wrapp" style={{ margin: "0px" }}>
          ...
          <div className="edit-brand-back-iconbox" onClick={() => setTab(35)}>
...
export default CinemaAddLeaderboardBanner;
