...
const AddLandingPageSquareTile = ({ get_mall_auth_data, setTab }) => {
      ...
      <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
        <div className="leaderboard-sub-wrapp" style={{ margin: "0px" }}>
          ...
          <p className="leaderboard-sub-heading">
            Purchase marketing space through our Landing Page Square Tiles Banner below
          </p>
        </div>
...
export default AddLandingPageSquareTile;
