...
import { CinemaHero, CinemaNavigationBar, LeaderBoardCard, PromotionBannerCard, RetailerNavigationBar } from "../../components";
...
const CinemaPromotionalBanner = ({ get_mall_auth_data, setTab, gettab,getMallDisclaimerData}) => {
  const perPage = 3;
        ...
        <>
          ...
          <div className="mm_main_wrapp">
            <div className="leaderboard-sub-wrapp leaderboard-sub-wrapp-cinema">
              <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 37 ? "Promotional Banner" : ""} />
              ...
              <div className="mall_name_wrapp mall_name_wrapp-spacebetween" style={{ marginTop: "0px", paddingLeft: "0rem" }}>
                <div className="leaderboard-inner-namebox">
                  ...
                  <span className="leaderboard-span" style={{ fontWeight: "600" }}>Promotional Banner</span>
...
export default CinemaPromotionalBanner;