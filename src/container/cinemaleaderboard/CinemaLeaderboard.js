...
import { CinemaHero, CinemaLeaderBoardCrad, CinemaNavigationBar, LeaderBoardCard, RetailerNavigationBar } from "../../components";
...
import EmptyCinemaLeaderboardCard from "../../components/cinemaleaderboardcard/EmptyCinemaLeaderboardCard";
...
const CinemaLeaderboard = ({ get_mall_auth_data, setTab, gettab, getMallDisclaimerData }) => {
    ...
    <div>
      {loading === true ? (
        ...
        <div className="mm_main_wrapp">
          ...
          <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 35 ? "In Mall Leaderboard Banner" : ""} />
            ...
            >
              <div className="leaderboard-inner-namebox">
                ...
                <span className="leaderboard-span" style={{ fontWeight: "600" }}> In Mall Leaderboard Banner</span>
              </div>
              {/* <button onClick={() => setTab(36)} className="leaderboard-btn">
                Add new{" "}
...
export default CinemaLeaderboard;