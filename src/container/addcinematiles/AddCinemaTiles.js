...
import { AddCinemaProductTileBannerCard, AddLeaderBoardCard, AddProductTilesBannerCard, AddPromotionBannerCard, CinemaHero } from '../../components';
...
const AddCinemaTiles = ({ get_mall_auth_data, setTab }) => {
    ...
    return (
        <>
            ...
            <div className="mm_main_wrapp leaderboard-sub-wrapp-cinema">
                <div className="leaderboard-sub-wrapp" style={{ margin: "0px" }}>
                    ...
                    <div className="mall_name_wrapp mall_name_wrapp-spacebetween" style={{ paddingLeft: "0rem" }}>
                        <div className="leaderboard-inner-namebox" >
                            ...
                            <span className="leaderboard-span" style={{ fontWeight: "600" }}>Add Cinema Product Tiles</span>
                        </div>
                ...
                <AddCinemaProductTileBannerCard openMallModal={openMallModal} setTab={setTab} gatweek={gatweek}
                    setWeek={setWeek}
