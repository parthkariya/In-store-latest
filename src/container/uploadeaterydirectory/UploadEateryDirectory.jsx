...
import { ACCEPT_HEADER, dowmtemp, eatery_sample_export, mall_eatery_import, uploadfile } from '../../utils/Constant';
...
const UploadEateryDirectory = ({ get_mall_auth_data, setTab, getTab }) => {
    ...
    const DownTemp = async () => {
        ...
        axios
            .post(eatery_sample_export, formdata, {
                headers: {
    ...
    const Uploadfile = async () => {
        if (files[0] === undefined) {
            ...
            axios
                .post(mall_eatery_import, formdata, {
                    headers: {
                        Accept: ACCEPT_HEADER,
                        Authorization: "Bearer " + token,
                    },
...
export default UploadEateryDirectory