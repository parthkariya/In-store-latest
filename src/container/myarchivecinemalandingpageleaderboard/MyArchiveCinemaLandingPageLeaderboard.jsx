...
import { CinemaHero, CinemaLandingPageLeaderboardCard, CinemaLandingPageTileCard, CinemaLeaderBoardCrad, CinemaNavigationBar, LeaderBoardCard, RetailerNavigationBar } from "../../components";
...
import MyArchiveCinemaLandingPageLeaderboardCard from "../../components/myarchivecinemalandingpageleaderboardcard/MyArchiveCinemaLandingPageLeaderboardCard";
...
const MyArchiveCinemaLandingPageLeaderboard = ({ get_mall_auth_data, setTab, getTab, gettab,getMallDisclaimerData, getExtendId, setExtendId }) => {
        ...
        <>
          ...
          <div className="mm_main_wrapp">
            <div className="leaderboard-sub-wrapp leaderboard-sub-wrapp-cinema">
              <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 57 ? "Landing Page Leaderboard Banner" : ""} />
              ...
              >
                <div className="leaderboard-inner-namebox">
                  ...
                  <span className="leaderboard-span" style={{ fontWeight: "600" }}>Landing Page Leaderboard Banner</span>
                </div>
              ...
              {/* {getliast && getliast.length > 0
                ...
                getliast.map((mall, mindx) => {
                  return ( */}
                    <MyArchiveCinemaLandingPageLeaderboardCard
                      openMallModal={openMallModal}
                      item={getExtendId}
                    //   mindx={mindx}
                      getLeaderboard={getLandingpageLeaderboard}
                ...
                <EmptyCinemaLandingpageLeaderboardCard
                  openMallModal={openMallModal}
                  item={""}
                  mindx={""}
                  getLeaderboard={getLandingpageLeaderboard}
...
export default MyArchiveCinemaLandingPageLeaderboard;