...
import EmptyCinemaLandingpageLeaderboard from "./EmptyCinemaLandingpageLeaderboard";
import EmptyCinemaLandingpageLeaderboardCard from "./EmptyCinemaLandingpageLeaderboard";
...
const CinemaLandingPageLeaderboard = ({ get_mall_auth_data, setTab, getTab, gettab,getMallDisclaimerData }) => {
  ...
  useEffect(() => {
    ...
    getCategoryApi();
    getWeekApi();
    ("main name is", get_mall_auth_data);
        ...
        <>
          ...
          <div className="mm_main_wrapp">
            <div className="leaderboard-sub-wrapp leaderboard-sub-wrapp-cinema">
              <CinemaNavigationBar title="Product Rate Card" setTabType={gettab == 42 ? "Landing Page Leaderboard Banner" : ""} />
...
export default CinemaLandingPageLeaderboard;