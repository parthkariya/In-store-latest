...
import {
  ...
  RetailerLandingPageSquareTileCardExtend,
...
import EmptyRetailLandingPageSquareTileCard from "../../components/retailLandingPageSquareTileCard/EmptyRetailLandingPageSquareTileCard";
...
const RetailerLandingPageSquareTileExtend = ({
  get_mall_auth_data,
  setTab,
  getTab,
  gettab,
        ...
        <>
          ...
          <div className="mm_main_wrapp">
            ...
            >
              <RetailerNavigationBar
                title="My Archive"
                setTabType={gettab === 37 ? "Landing Page Square Tiles" : ""}
              />
              ...
              {/* );
                ...
                <EmptyRetailLandingPageSquareTileCard
                  openMallModal={openMallModal}
                  item={""}
                  mindx={""}
                  getLeaderboard={getLandingpageTile}
              ...
              {totalPages !== page && (
                ...
                >
                  {loading
                    ? "Loading..."
                    : " Load More Landing Page Square Tiles"}
                  <BsChevronDown />
                </button>
              )}
...
export default RetailerLandingPageSquareTileExtend;
