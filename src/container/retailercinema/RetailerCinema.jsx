...
import { CinemaHero, MallHero, StoreDCard, StoreRetailerDCard } from "../../components";
...
const RetailerCinema = ({getsingleStoreData2,get_mall_auth_data,setTab,getstore_is2,setStore_id2,setSingleStoreData2  }) => {
    ...
    <>
      ...
      <div className="mm_main_wrapp">
        <div className="mall_name_wrapp mall_name_wrapp_brand_mall mall_mall_name_wrapp">
          ...
          <span className="mall_mall_name_heading" style={{fontWeight:"600"}}>Cinemas</span>
        </div>
