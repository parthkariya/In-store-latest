...
import { CustomerEateriesDetailsComponent, CustomerEateryHero } from '../../components'
import { IoChevronBack } from 'react-icons/io5'
import { ACCEPT_HEADER, get_category } from '../../utils/Constant';
import axios from 'axios';
import { HiOutlineSearch } from 'react-icons/hi';

const CustomerRetailerEateryDetails = ({getsingalmalldata, getedetalis, getedetalis2, setTab, setIsRetailer, isRetailer, setcheckID,SetNavBarData,
    SetNavBarDataName,
    SetNavBarData1,
    respSearch,
    setResponSearch,}) => {
  ...
  return (
    ...
    <CustomerEateryHero getsingalmalldata={getsingalmalldata} getedetalis={getedetalis2} />
    <div className="mall_nearme_brand_main_wrapp">
        <div>
            <div className="mm_main_wrapp mm_main_wrapp_22" style={{ marginBottom: "40px" }}>
                <div className='edit-brand-back-iconbox' onClick={() => setTab(27)}><IoChevronBack className='edit-brand-back-icon' /> <p className='edit-brand-back-txt'>Back</p></div>
                {/* heading */}
                <div
                ...
                >
                    ...
                    >
                        {getedetalis2.name} - {getsingalmalldata.name}
                    </h4>
                    {/* &nbsp;&nbsp; <span className="h3">Eateries</span> */}
                </div>
                <CustomerEateriesDetailsComponent getedetalis={getedetalis2} setTab={setTab} getsingalmalldata={getsingalmalldata} setIsRetailer ={setIsRetailer} isRetailer={isRetailer} getIdTrue={2} setcheckID={setcheckID}/>

                <div className='edit-brand-back-iconbox' onClick={() => setTab(27)} style={{marginTop:"2rem"}}><IoChevronBack className='edit-brand-back-icon' /> <p className='edit-brand-back-txt'>Back</p></div>
...
export default CustomerRetailerEateryDetails