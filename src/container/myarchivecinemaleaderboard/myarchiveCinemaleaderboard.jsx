...
import "./myarchiveCinemaleaderboard.css";
import images from "../../constants/images";
import {
  CinemaHero,
  CinemaNavigationBar,
  LeaderBoardCard,
  MyArchiveCinemaLeaderboardCard,
...
const MyArchiveCinemaLeaderboard = ({
  get_mall_auth_data,
  setTab,
  gettab,
  getExtendId,
        ...
        <>
          ...
          <div className="mm_main_wrapp">
            <div className="leaderboard-sub-wrapp" style={{ gap: "1rem" }}>
              <CinemaNavigationBar
                title="My Archive"
                setTabType={gettab == 52 ? "In Mall Leaderboard Banners" : ""}
              />
...
export default MyArchiveCinemaLeaderboard;
