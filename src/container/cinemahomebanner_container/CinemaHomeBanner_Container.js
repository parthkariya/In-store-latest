...
const CinemaHomeBanner_Container = ({ getHomeData }) => {
  ...
  const getHomeDataLandingApi = async () => {
    setLoading(true);
    axios
      .get(get_landingpage_leaderboard_without_auth, {
        headers: {
          Accept: ACCEPT_HEADER,
        },
      })
  ...
  return (
    <>
      {loading === true ? (
        ...
        <>
          <div className="CinemaHomeBanner_img_inner_main" style={{ cursor: "pointer" }} onClick={() => {
