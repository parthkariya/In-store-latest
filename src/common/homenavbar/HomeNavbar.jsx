...
const HomeNavbar = (
  ...
  const { RegisterCustomer, setMallRegister, forgotPassword } = useAuthContext();
  ...
  const SigninCustomerFacebook = async (fdata, type) => {
    ...
    if (data) {
      if (data.success === 1) {
        ...
        setEmail("");
        // window.location.reload(false);
        console.log("successfully login through facebook");

      } else if (data.success === 0) {
        console.log("unsuccessfully login through facebook");
      }
    }
  };
    ...
    <>
                  ...
                  <>
                    <div className="navbar-acc-menu-open-warapp">
                      ...
                      {login === false || login === null ? (
                        <Link
                          className="navbar-acc-menu-link" style={{ fontSize: "14px" }}
                          onClick={() => {
                      ...
                      <Link className="navbar-acc-menu-link"
                        ...
                        style={{
                          color:
                            location.pathname === "/CinemaPage" ? "#ff8b00" : "black",
                          fontWeight: location.pathname === "/CinemaPage" ? "600" : "400",
                          fontSize: "14px"
                        }}>
                        Cinema Registration
                      </Link>
                      ...
                      {login === "true" && getrole == 2 ? (
                        <Link className="navbar-acc-menu-link" style={{ fontSize: "14px" }}
                          to="/profile-page"
                      ...
                      {login === "true" && getrole == 4 ? (
                        <Link to="/mallnearme" className="navbar-acc-menu-link" style={{ fontSize: "14px" }}
                      ...
                      {login === "true" && getrole == 6 ? (
                        <Link to="/CinemaDashboard" className="navbar-acc-menu-link" style={{ fontSize: "14px" }}
                        // className="navbar-acc-menu-link"
                        >
                          Cinema Dashboard
                        </Link>
                      ...
                      {login === "true" ? (<><Link onClick={logout} className="navbar-acc-menu-link" style={{ fontSize: "14px" }}>Logout</Link></>) : (<></>)}
              ...
              {getaccountOpen && (
                <div className="accunt_sec_wrapp">
                  {login === "true" ? (
                    ...
                    <Link onClick={() => { setIsOpen3(true); SetsignButn(3), SetboldButn(3) }}>Consumer Login / Signup</Link>
                  )}
      ...
      <ReactModal
        ...
        <div className="home_login_model_1sec_inner">
          ...
          <button className="h6 mb_10 mt_10" style={{ alignSelf: "end" }}>
            Not Registered yet?
          </button>
          <button
            onClick={() => {
      ...
      <ReactModal
        ...
        <div className="home_login_model_1sec_inner">
          ...
          <div className="sign_input_wrapp">
            ...
            <div
              ...
              <input
                ...
                id=""
                className="signup_input"
                style={{ background: "#DAD9D8", border: "none", width: "100%", fontSize: '16px' }}  // Set font size to 16px to prevent zoom }}
              />
          ...
          <button className="h6 mb_10 mt_10" style={{ alignSelf: "end", marginBottom: "0.8rem" }}>
            Not Registered yet?
          </button>
          <button
            onClick={() => {
