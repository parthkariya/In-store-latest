...
import {
  ...
  get_cinema_landing,
  get_mall,
  get_mall_from_region_for_store,
  get_mall_landing,
  get_mall_master,
  unregisterd_cinema_retailer,
} from "../../utils/Constant";
...
const CinemaPage = () => {
  ...
  const { setLogin, RegisterCustomer, region_data,forgotPassword,login_loading } = useAuthContext();
  ...
  useEffect(() => {
    ...
    getMallModalApi();
    // ("Get Home Data--->", cinema_mall_data);
  }, []);
