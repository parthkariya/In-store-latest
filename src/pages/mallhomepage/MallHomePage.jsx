...
import {
  ...
  dynamic_model_popup,
  get_mall,
  get_mall_from_region,
  get_mall_landing,
  get_mall_master,
  get_mall_master_by_id,
  get_mall_master_new,
} from "../../utils/Constant";
...
const MallHomePage = () => {
  ...
  const { setMallRegister,mall_signup_loading,login_loading } = useAuthContext();
  ...
  const SigninMall = async (type) => {
    ...
    if (getmallregion == "") {
      ...
      alert("Upload VAT Registration Document....!");
      return;
      ...
      //   company_reg_no:getcompanyregnumber,
      //   vat_no: getvat_no,
      //   earh_no: getearh_no,
      //   role: 2,
      //   email: getemail,
  ...
  // console.log("getmallarray", getmallarray);
  ...
  // console.log("getmallarray",getmallarray);
  // console.log("getmallmasterid",getmallmasterid);
  ...
  return (
    <>
      {loading === true || mall_signup_loading === true || login_loading === true ? (
        <div
          style={{
            width: "100%",
            height: "80vh",
      ...
      /> */}
          ...
          <div>
            ...
            <p style={{ fontSize: "14px", textAlign: "center", fontWeight: "800", color: "var(--color-black)", marginBottom: "2rem" }}>{getMallHomeData?.benifit_footer}</p>
            <div className="mall-home-reg-btn">
              <button
                className="btn btn2"
                style={{ width: "225px", padding: "0px", fontSize: "16px" }}
                onClick={() => {
                  setIsOpen(true);
                  // modalIsOpen3
                }}
          ...
          {regButn == 1 ? (
            <div className="home_model_4wrapp">
              ...
              {getDropDown === true ? <></> : <>
                <div className="sign_input_wrapp">
                  ...
                  {/* <Select
                    ...
                    placeholder=""
                    // isMulti
                    // options={getmallarray.map((item) => ({
                    //   value: item.value,
                    //   label: `${item.label}`,
                    // }))}
                    // onChange={(selectedOptions) => {
                    //   const selectedMallIds = selectedOptions.map((option) => option.value);
                    //   setMallsOption(selectedOptions);

                    //   // Set the mall region based on the first selected mall ID
                    //   if (selectedMallIds.length > 0) {
                    //     const firstMallId = selectedMallIds[0];
                    //     SetMallRegion(firstMallId);

                    //     // Find the corresponding mall details
                    //     const selectedMall = getmallarray.find((mall) => mall.id == firstMallId);

                    //     if (selectedMall) {
                    //       setAddress(selectedMall.address); // Set the address if found
                    //     } else {
                    //       setAddress(""); // Clear address if no matching mall found
                    //     }
                    //   } else {
                    //     setAddress(""); // Clear address if no mall selected
                    //   }
                    // }}
              ...
              {getDropDown === true ? <>
                ...
                <div className="sign_input_wrapp">
                  <label htmlFor="email">
                    Select your region<span className="star_require">*</span>
                  </label>
                  <div className="select-wrapper" style={{ width: "100%" }}>
              ...
              <div className="sign_input_wrapp">
                <label htmlFor="mall">
                  Address<span className="star_require">*</span>
                </label>
                <input
                  type="text"
                  // value={getearh_no}
              ...
              <div className="sign_input_wrapp">
                <label htmlFor="first-name">First name<span className="star_require">*</span>
                </label>
                <input
                  type="text"
                  value={getfirstname}
              ...
              <div className="sign_input_wrapp">
                <label htmlFor="email">Email address<span className="star_require">*</span>
                </label>
                <input
                  type="email"
              ...
              <div className="signup_terms_wrapp mb_16" style={{ marginBottom: "1rem" }}>
                <input
                  type="checkbox"
                  value={isAcceptTerm2}
